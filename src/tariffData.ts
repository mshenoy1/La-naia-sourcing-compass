...
export const COUNTRY_PROFILES: CountryProfile[] = [
  ...
  },
  {
    ...
    leadTimeDaysMax: 20,
    moqUnits: 250,
    ftaNote: 'USMCA-qualifying goods: 0% reciprocal tariff and typically 0% MFN duty when rules of origin are met.',
    risks: [
      'Rules-of-origin documentation burden to qualify for USMCA',
      'Narrower manufacturing base for some product categories',
      'Border/customs congestion at peak season',
    ],
    notes: 'Nearshoring standout — short trucking lead times and low freight, with USMCA duty relief when goods qualify.',
  },
  {
    code: 'TW',
    name: 'Taiwan',
